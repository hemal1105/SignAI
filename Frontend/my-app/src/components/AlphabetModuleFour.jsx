...
// Importing specific signs for Module 4
...
// The data array for Module 4
const alphabetModuleData = [
    { id: 1, letter: "P", signImage: signP },
    { id: 2, letter: "Q", signImage: signQ },
    { id: 3, letter: "R", signImage: signR },
    { id: 4, letter: "S", signImage: signS },
    { id: 5, letter: "T", signImage: signT }
];

const AlphabetModuleFour = () => {
                    ...
                    {currentIndex === alphabetModuleData.length - 1 ? (
                        ...
                        >
                            ...
                            <motion.button
                                ...
                                whileTap={{ scale: 0.9, y: 8 }}
                                onClick={() => navigate('/quiz/alphabets/mod4')}
                            >
                                🎮 Play Game!
                            </motion.button>
                        </div>
...
export default AlphabetModuleFour;
