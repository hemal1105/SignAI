        ...
        return (
            <div className={styles.quizPage}>
                ...
                >
                    ...
                    <button className={`${styles.actionBtn} ${styles.practiceBtn}`} onClick={() => navigate('/practice', { state: { startLetter: 'K', endLetter: 'O' } })}>
                        Start Practice Mode 🎯
                    </button>
...
export default AlphabetQuizThree;
