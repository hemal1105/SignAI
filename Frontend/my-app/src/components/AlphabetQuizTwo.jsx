        ...
        return (
            <div className={styles.quizPage}>
                ...
                >
                    ...
                    <button className={`${styles.actionBtn} ${styles.practiceBtn}`} onClick={() => navigate('/practice', { state: { startLetter: 'F', endLetter: 'J' } })}>
                        Start Practice Mode 🎯
                    </button>
...
export default AlphabetQuizTwo;
